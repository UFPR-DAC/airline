	...
	return (
		<div className="flex flex-col gap-2">
			<div className="flex gap-4 bg-amber-200 p-8 rounded-2xl rounded-tl-none">
				...
				<div className="flex items-center rounded-md outline-1 outline-gray-300 bg-white pl-3 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-green-400">
					<label htmlFor="origin" className="block text-sm/6 font-medium text-gray-900">
						Datas
					</label>
					<div className="m-2">
			...
			{isDatepickerOpen && (
				<div className="max-h-[80vh] overflow-y-auto space-y-8 bg-amber-200 p-8 rounded-2xl">
